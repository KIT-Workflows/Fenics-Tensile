...
class FenicsYoungsModulusTestSimulation():
    ...
    def __call__(self, inp):
        ...
        # Todo: - include a check and errors for missing parameters?
        # Todo: - compute real discretized surface area
        # ! This a red comment
...
if __name__ == '__main__':
    ...
    import_inputs = wano_file["Import-inputs"]
    ...
    if import_inputs:
        ...
        E = wano_file["E"]
        nu = wano_file["nu"]
        height = wano_file["height"]
        diameter = wano_file["diameter"]
        displ = literal_eval(wano_file["displacement"])[0]
        input = {"E": E, "nu": nu, "height": height, "diameter": diameter, "displ": displ}
    ...
    data = {}
    data["force"] = model_answer['force']
    data["stress"] = model_answer['stress'] 
